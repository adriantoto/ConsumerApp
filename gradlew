...
public class MovieFavoriteAdapter extends RecyclerView.Adapter<MovieFavoriteAdapter.MovieFavoriteViewHolder> implements Rem{
    ...
    class MovieFavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        MovieFavoriteViewHolder(@NonNull View itemView) {
            ...
            itemFavoriteMovie = itemView.findViewById(R.id.cv_favorite_m